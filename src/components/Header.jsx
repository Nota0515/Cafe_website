  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-n-2">
      <div className="flex item-center border-n-3 border-b-2 justify-between mt-5 px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className='block w-[20rem] h-[6.25rem] justify-center pt-5 text-n-5 font-bold -ml-2 items-center overflow-hidden mb-2' href='#home'>
          <img src={saravanalogo} width={100} height={60} alt='saravanalogo' className='-mt-5' />
          <span className=' absolute top-1/2 left-32 scale-150 ml-5 lg:ml-10 font-poppins' href="#home">Saravan Dosa</span>
        </a>
